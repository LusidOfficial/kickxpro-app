/* ──────────────────────────────────────────────
   ...
   /coach/* pages with Simplified/Classic toggle.
   ────────────────────────────────────────────── */
"use client";
...
export default function CoachLayout({
  ...
  useEffect(() => {
    const saved = localStorage.getItem("kickxpro_classic_mode");
  ...
  const toggle = () => {
    ...
    setIsClassic(next);
    localStorage.setItem("kickxpro_classic_mode", String(next));
  };

  const navItems = isClassic
    ? [...NAV_ITEMS.coachClassic]
    : [...NAV_ITEMS.coach];
